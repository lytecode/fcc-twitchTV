...
tvApp.controller('onlineController', ['$scope','$http', function($scope, $http){
...
/* controller for offline channels */

tvApp.controller('offlineController', ['$scope', function($scope){
  $scope.cs = [
     {
       "stream": {
         "mature": false,
